...
console.log('🍷 3단계 와인 자동 생성 테스트')
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
console.log(`와인명: ${WINE_TITLE}`)
console.log(`와이너리: ${WINERY}`)
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n')

async function test3StageWorkflow() {
  try {
    ...
    console.log('📄 2단계: Vivino에서 기본 정보 추출 중...\n')
    ...
    console.log(`  - 가격: ${step3Result.price ? `${step3Result.price}원` : 'N/A'}`)
    console.log(`  - 알코올: ${step3Result.abv}%`)
    console.log(`  - 평점: ${step3Result.points}/5.0`)
    console.log(`\n지역 정보:`)
